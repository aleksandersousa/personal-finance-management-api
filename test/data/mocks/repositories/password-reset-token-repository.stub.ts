import { PasswordResetTokenRepository } from '@/data/protocols/repositories';
  ...
  implements PasswordResetTokenRepository
{
  ...
  async create(
    ...
    const tokenModel: PasswordResetTokenModel = {
  ...
  async findRecentByUserId(
    ...
    return Array.from(this.tokens.values())
      .filter(t => t.userId === userId && t.createdAt >= cutoffDate)
   ...
   */
  seed(tokens: PasswordResetTokenModel[]): void {
   ...
   * Get token by ID
   */
  getTokenById(id: string): PasswordResetTokenModel | undefined {
   ...
   */
  getTokensByUserId(userId: string): PasswordResetTokenModel[] {
